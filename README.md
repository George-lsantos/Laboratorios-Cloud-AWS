...
| **16** | WordPress Altamente Disponível | EC2, ALB, Auto Scaling, RDS, EFS, VPC | Implementação de arquitetura WordPress altamente disponível utilizando Load Balancer, Auto Scaling, armazenamento compartilhado com EFS e banco de dados gerenciado com RDS em múltiplas Availability Zones. | [Acessar](https://github.com/George-lsantos/Laboratorios-Cloud-AWS/tree/main/lab-16-aws-wordpress-ha-efs-rds) |
