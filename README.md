...
| **17** | WordPress Altamente Disponível | EC2, ALB, Auto Scaling, RDS, EFS, VPC, CloudFront, Route 53, ACM, Systems Manager | Implementação de uma arquitetura WordPress altamente disponível e escalável na AWS utilizando Application Load Balancer e Auto Scaling Group para escalabilidade automática, Amazon EFS para armazenamento compartilhado entre instâncias e Amazon RDS Multi-AZ para alta disponibilidade do banco de dados. | [Acessar](https://github.com/George-lsantos/Laboratorios-Cloud-AWS/tree/main/lab-17-aws-wordpress-ha-efs-rds) |
| **18** | Amazon WorkSpaces + AD Connector | Amazon WorkSpaces, AWS Directory Service, AD Connector, Active Directory, VPC, Security Groups, Systems Manager | Implementação de uma infraestrutura de Desktop Virtual (VDI) na AWS utilizando Amazon WorkSpaces integrado ao Active Directory através do AWS Directory Service (AD Connector), permitindo autenticação centralizada, gerenciamento seguro e administração de ambientes corporativos híbridos. | [Acessar](https://github.com/George-lsantos/Laboratorios-Cloud-AWS/tree/main/lab-18-aws-workspaces-adconnector-hybrid) |
| **19** | AWS Client VPN + Hybrid Connectivity | AWS Client VPN, Transit Gateway, VPC, CloudWatch, Route Tables, Authorization Rules | Implementação de conectividade segura entre ambientes corporativos e redes AWS utilizando AWS Client VPN integrado a múltiplas VPCs através do AWS Transit Gateway, com monitoramento via CloudWatch e controle de acesso por rotas e regras de autorização. | [Acessar](https://github.com/George-lsantos/Laboratorios-Cloud-AWS/tree/main/lab-19-aws-client-vpn-hybrid-connectivity) |
---
